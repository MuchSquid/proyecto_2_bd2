...
import { Input, Button, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow, Modal, ModalContent, ModalBody, Select, SelectItem } from "@nextui-org/react";
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setData({
        ...
        execution_time_ms: combinedResult.execution_time_ms,
        Query: combinedResult.query,
      });
  
      // Set the table data
      setTableData(combinedResult.data);
    } catch (err) {
  ...
  return (
    <div className="flex flex-row h-screen">
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        ...
        <div className="mt-6">
          <Table aria-label="Resultados de la consulta" removeWrapper className='bg-neutral-100 rounded-lg px-5 py-3 shadow-md dark:bg-transparent' checkboxesProps={{
        classNames: {
      ...
      classNames={classNames} >
            <TableHeader>
              <TableColumn className='bg-transparent font-light'>Track ID</TableColumn>
              <TableColumn className='bg-transparent font-light'>Nombre de la Canción</TableColumn>
              <TableColumn className='bg-transparent font-light'>Similitud</TableColumn>
            </TableHeader>
            <TableBody>
        ...
        <motion.div
          className="w-[30%] p-2 overflow-y-auto shadow-md"
          style={{
            // background: `linear-gradient(180deg, rgba(0, 0, 0, 0.8), ${backgroundColor})`,
            color: textColor,
          }}
        ...
        {selectedTrack ? (
          <div className="flex flex-col items-center m-10">
            <img 
              ...
              ref={imgRef}
              style={{ boxShadow: `0px 0px 70px ${boxShadowColor}` }} 
            />
